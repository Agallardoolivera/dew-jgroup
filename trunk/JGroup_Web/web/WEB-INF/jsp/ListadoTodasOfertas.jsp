                    ...
                    <div style="height:600px;">
                      ...
                      <form id="Salir" name="Salir" method="post" action="">
                        ...
                        <table width="749" border="0">
                          <tr>
                            <td width="146"><p align="center">&nbsp;</p>
                            </td>
                            <td width="385"><p align="center"><a href="consultacotizacion2.htm?metodo=ConsultaCotizacion2"><img src="<%=request.getContextPath()%>/imagesmostrar.png" alt="a" width="49" height="40" border="0" align="middle" title="Ver ofertas registradas"/></a></p>
