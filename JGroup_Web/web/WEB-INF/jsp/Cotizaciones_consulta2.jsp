            ...
            <div id="header">
                <table border="0" cellpadding="2" cellspacing="2" width="100%">
                    <tr>
                        ...
                        <td width="10%"><p align="center"><a href="listaofertas.htm?metodo=ListaOferta"><img src="<%=request.getContextPath()%>/images/Browser History.png" width="49" height="40" border="0" align="middle" title="Usuario"/></a></p>
                    ...
                    <div style="height:350px;">
                      <table width="792" border="0">
                        <tr>
                          ...
                          <td width="299">&nbsp;</td>
                          <td colspan="2"><!-- #BeginDate format:fcSw1a -->Wednesday, 30 June, 2010 1:27 AM<!-- #EndDate --></td>
                        </tr>
                        <tr>
