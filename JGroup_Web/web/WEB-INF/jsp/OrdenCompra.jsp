...
<body topmargin="0" leftmargin="0" rightmargin="0">
                ...
                <div id="contenido" align="center">
                    <div style="height:350px;">
                      <table width="792" border="0">
                        <tr>
                          <td width="96" height="38"><span class="Estilo11">Cotizacion</span></td>
                          <td width="144"><input type="text" name="Tx_NumCot" /></td>
                          <td width="299">&nbsp;</td>
                          <td colspan="2"><!-- #BeginDate format:fcSw1a -->Wednesday, 30 June, 2010 1:42 AM<!-- #EndDate --></td>
                        </tr>
                        <tr>
                          <td height="34" class="Estilo11">&nbsp;</td>
                      ...
                      <table width="696" border="1">
                        <tr>
                          <th width="63" scope="col">Codigo</th>
                          <th width="161" scope="col">Nombre</th>
                          <th width="95" scope="col">RUC</th>
                          <th width="349" scope="col">Direccion</th>
                        </tr>
                        <tr>
                          <th scope="row">&nbsp;</th>
                          <td>&nbsp;</td>
                      ...
                      <table width="742" border="1">
                        <tr>
                          <th width="63" scope="col">Codigo</th>
                          <th width="221" scope="col">Detalles Producto </th>
                          <th width="94" scope="col">Preciario</th>
                          <th width="97" scope="col">Lugar Destino </th>
                          <th width="113" scope="col">Fecha Llegada </th>
                          <th width="114" scope="col">Forma de envio </th>
                        </tr>
                        <tr>
                          <th scope="row">&nbsp;</th>
                          <td>&nbsp;</td>
                      ...
                      <table width="686" border="0">
                        <tr>
                          ...
                          <td width="101">&nbsp;</td>
                          <td width="116">&nbsp;</td>
                          <td width="82"><input name="Cancelar OC" type="button" id="Cancelar OC" value="Cancelar OC" size="" /></td>
                          <td width="83"><input name="Enviar OC" type="button" id="Enviar OC" value="Enviar OC" size="" /></td>
                        </tr>
                      </table>
                      <p>&nbsp;</p>
        ...
        <div class="yuiextdlg" id="cf_windowblistaped" style="display:none;">
            <div class="x-dlg-hd"  id="cf_windowblistaped_title"></div>
</body>
</html>